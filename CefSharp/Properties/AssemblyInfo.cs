...
namespace CefSharp
{
    public static class AssemblyInfo
    {
        ...
        public const string CefSharpCoreProject = "CefSharp.Core";
        public const string CefSharpBrowserSubprocessProject = "CefSharp.BrowserSubprocess";
        public const string CefSharpBrowserSubprocessCoreProject = "CefSharp.BrowserSubprocess.Core";
        public const string CefSharpWpfProject = "CefSharp.Wpf";
        public const string CefSharpWinFormsProject = "CefSharp.WinForms";
        public const string CefSharpOffScreenProject = "CefSharp.OffScreen";
        public const string CefSharpTestProject = "CefSharp.Test";
